...
示例代码以仓库内 `*_test.go` 与 `func Example*` 为准（`go test` 校验）。完整独立接入示例见 [examples/gamestore/README.md](../../examples/gamestore/README.md)；存量裸写迁移示例见 [examples/gamestore-migrate/README.md](../../examples/gamestore-migrate/README.md)。
